"""
Django settings for movie_recommender_project project.
...
CORS_ALLOWED_ORIGINS = config(
    ...
    default="http://localhost:3000,https://movie-recommender-frontend.vercel.app",
...
WSGI_APPLICATION = "movie_recommender_project.wsgi.application"
